...
* #8. 클러스터 오토 스케일링
  ...
  - [HPA](https://github.com/gnosia93/eks-on-aws/blob/main/tutorial/eks-hpavpa.md)(p)
...
* #9. 성능 메트릭 모니터링(Observability)
  ...
  - [SSO 을 위한 Keycloak 서버 구축](https://github.com/gnosia93/eks-on-aws/blob/main/tutorial/sso-keycloak.md)(p)
...
* [#12. 클러스터 업그레이드](https://github.com/gnosia93/eks-on-aws/blob/main/tutorial/eks-upgrade.md)(p)
