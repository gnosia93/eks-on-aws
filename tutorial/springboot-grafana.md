...
OpenTelemetry 의 메트릭 수집 설정은 기존 Peometheus 의 설정을 그대로 계승하는데, [PROMETHEUS CONFIGURATION](https://prometheus.io/docs/prometheus/latest/configuration/configuration/) 에서 설정과 관련된 전반적인 내용을 확인할 수 있다.
